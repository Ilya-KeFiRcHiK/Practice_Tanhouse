...
function getTownhouses() {
    ...
    $sql = "SELECT * FROM tanhouses WHERE id = 4";
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <div class="review-card">
          <img src="img/Untitled (5).svg" alt="Фото таунхауса" class="property-photo">
        </div>
      </div>
      
      <div class="swiper-slide">
        <div class="review-card">
          <img src="img/Untitled (7).svg" alt="Фото таунхауса" class="property-photo">
        </div>
      </div>
      
      <div class="swiper-slide">
        <div class="review-card">
          <img src="img/Untitled (3).svg" alt="Фото таунхауса" class="property-photo">
        </div>
      </div>
      
      <div class="swiper-slide">
        <div class="review-card">
          <img src="img/kitchen4.svg" alt="Фото таунхауса" class="property-photo">
        </div>
      </div>
    </div>
