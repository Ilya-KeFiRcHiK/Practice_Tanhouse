...
function getTownhouses() {
    ...
    $sql = "SELECT * FROM townhouses WHERE id = 4";
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="property-feature">
                                <p><a href="https://yandex.ru/maps/22/kaliningrad/house/polevoy_pereulok_6/ZkkYcwNpSkUEQFtufXtzdHVkYw==/?ll=20.549303%2C54.725977&z=17.13"><i class="bi bi-geo-alt"></i></a> ' . htmlspecialchars($townhouse['address']) . '</p>
                            </div>
...
try {
    ...
    $townhouse_id = isset($_GET['id']) ? (int)$_GET['id'] : 4;
    
    // Получаем все характеристики таунхауса
    $stmt = $pdo->prepare("SELECT * FROM townhouse4_properties WHERE townhouse_id = ? ORDER BY property_type");
