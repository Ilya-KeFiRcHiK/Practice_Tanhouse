...
function getTownhouses() {
    ...
    $sql = "SELECT * FROM tanhouses WHERE id = 2";
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <div class="review-card">
          <img src="img/Untitled (1).svg" alt="Фото таунхауса" class="property-photo">
        </div>
      </div>
      <div class="swiper-slide">
        <div class="review-card">
      ...
      <div class="swiper-slide">
        <div class="review-card">
          <img src="img/Untitled (2).svg" alt="Фото таунхауса" class="property-photo">
        </div>
      </div>
      
      <div class="swiper-slide">
        <div class="review-card">
          <img src="img/Untitled.svg" alt="Фото таунхауса" class="property-photo">
        </div>
      </div>
    </div>
